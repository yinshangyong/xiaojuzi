 ...
 */
public class HotStarGvAdapter extends BaseAdapter {
    private List<Stars.DataBean.HotBean> starBeen;
    private Context context;

    public HotStarGvAdapter(List<Stars.DataBean.HotBean> starBeen, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Stars.DataBean.HotBean starBeans = starBeen.get(position);

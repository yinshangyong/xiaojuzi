 ...
 */
public class VedioDetailAdapter extends CommonAdapter<VedioDetail.DataBean.CommentBean.ListBean> {
     private  Context context;

    public VedioDetailAdapter(Context context, int layoutId, List<VedioDetail.DataBean.CommentBean.ListBean> list) {
        super(context, layoutId, list);
        this.context=context;
    }

    @Override
    public void convert(ViewHolderM holderM, VedioDetail.DataBean.CommentBean.ListBean bean) {

...
public class MyimaView extends ImageView {
    ...
    public MyimaView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MyimaView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Drawable drawable = getDrawable(); if (null != drawable) {
            ...
            final Rect rectDest = new Rect(0,0,getHeight(),getHeight());
            paint.reset();

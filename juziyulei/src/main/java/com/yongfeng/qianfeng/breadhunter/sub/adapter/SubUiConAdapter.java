 ...
 */
public class SubUiConAdapter extends BaseAdapter {
    private  Context context;
    private List<SubUi.DataBean.ListBean>list;

    public SubUiConAdapter(Context context, List<SubUi.DataBean.ListBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        SubUi.DataBean.ListBean bean=list.get(position);

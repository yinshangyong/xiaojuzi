...
public class StarGvAdapter extends BaseAdapter {
    private List<Finds.DataBean.StarBean> starBeen;
    private Context context;

    public StarGvAdapter(List<Finds.DataBean.StarBean> starBeen, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Finds.DataBean.StarBean starBeans = starBeen.get(position);
